...
- Launches the application with Login screen
...
Anonymous visitors can browse events **without logging in** by clicking "Browse Events as Guest" on the login screen.
