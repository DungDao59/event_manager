...
public class Session {
    ...
    /**
     * Set presenter IDs (used when loading from database).
     * @param ids list of presenter IDs
     */
    public void setPresenterIds(List<Integer> ids) {
        presenterIds.clear();
        if (ids != null) {
            presenterIds.addAll(ids);
        }
    }

    /**
     * Set material IDs (used when loading from database).
     * @param ids list of material IDs
     */
    public void setMaterialIds(List<Integer> ids) {
        materialIds.clear();
        if (ids != null) {
