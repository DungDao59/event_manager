...
public class DatabaseConnection {
    ...
    public static void setUpDatabase(){
        try(Connection conn = getConnection()){
            ...
            // Note: initial_data.sql loading is disabled because the SQL file
            // uses 'password_hash' column but schema uses 'password' column.
            // Users should register new accounts through the UI instead.
