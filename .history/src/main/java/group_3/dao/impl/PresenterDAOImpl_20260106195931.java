...
public class PresenterDAOImpl implements PresenterDAO {
    ...
    public int create(Presenter presenter) {
        String personSql = "INSERT INTO person (username, password, full_name, date_of_birth, contact_information, role) VALUES (?, ?, ?, ?, ?, ?) RETURNING id";
        String presenterSql = "INSERT INTO presenter (person_id, presenter_role, statistics) VALUES (?, ?, ?)";
