...
public class RegistrationController {
    ...
    public void initialize() {
        ...
        // Configure DatePicker - restrict to dates not exceeding today
        configureDatePicker();
    ...
    private void configureDatePicker() {
        ...
        dateOfBirthPicker.setDayCellFactory(picker -> new javafx.scene.control.DateCell() {
            @Override
        ...
        // Set a reasonable default (empty, user must select)
    ...
    private void handleRegister(ActionEvent event) {
        ...
        // Hash the password
            String passwordHash = PasswordUtil.hash(password);        try {
            Person newUser;
